...
const contracts_service_js_1 = require("./contracts.service.js");
...
exports.ContractsModule = ContractsModule = __decorate([
    (0, common_1.Module)({
        providers: [contracts_service_js_1.ContractsService],
        exports: [contracts_service_js_1.ContractsService],
    })
], ContractsModule);
